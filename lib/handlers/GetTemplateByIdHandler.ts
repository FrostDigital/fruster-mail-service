...
export const GET_TEMPLATE_BY_ID_HTTP_SUBJECT = "http.get.mail.template.:id";
export const GET_TEMPLATE_BY_ID_SUBJECT = "mail-service.get-template-by-id";
...
class GetTemplateByIdHandler {
	...
	async handleHttp({ params, user }: FrusterRequest<any, {id: string}>): Promise<FrusterResponse<Template>> {
